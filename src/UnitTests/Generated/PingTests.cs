...
namespace Elasticsearch.Client.UnitTests
{
    ...
    public class PingTests
    {
        ...
        public PingTests(ElasticsearchClient client)
        {
            this.mClient = client;
        }
        
        public virtual async Task TestPing(HttpStatusCode expectedStatusCode, string expectedContent)
        {
            HttpResponseMessage syncResponse = mClient.Ping();
            ...
            HttpResponseMessage asyncResponse = await mClient.PingAsync();
