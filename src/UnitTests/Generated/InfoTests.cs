...
namespace Elasticsearch.Client.UnitTests
{
    ...
    public class InfoTests
    {
        ...
        public InfoTests(ElasticsearchClient client)
        {
            this.mClient = client;
        }
        
        public virtual async Task TestInfo(HttpStatusCode expectedStatusCode, string expectedContent)
        {
            HttpResponseMessage syncResponse = mClient.Info();
            ...
            HttpResponseMessage asyncResponse = await mClient.InfoAsync();
