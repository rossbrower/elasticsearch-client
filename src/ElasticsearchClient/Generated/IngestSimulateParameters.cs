namespace Elasticsearch.Client
{
    ...
    public class IngestSimulateParameters : Parameters
    {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual IngestSimulateParameters pretty(bool value)
        {
        ...
        public virtual IngestSimulateParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual IngestSimulateParameters error_trace(bool value)
        {
        ...
        public virtual IngestSimulateParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual IngestSimulateParameters filter_path(string value)
        {
