namespace Elasticsearch.Client
{
    ...
    public class CatFielddataParameters : Parameters
    {
        ...
        ///<param name="value"></param>
        public virtual CatFielddataParameters s(string value)
        {
            SetValue("s", value);
            return this;
        }
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatFielddataParameters pretty(bool value)
        {
        ...
        public virtual CatFielddataParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatFielddataParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatFielddataParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatFielddataParameters filter_path(string value)
        {
