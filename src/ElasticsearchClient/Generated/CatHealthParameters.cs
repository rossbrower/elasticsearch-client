namespace Elasticsearch.Client
{
    ...
    public class CatHealthParameters : Parameters
    {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatHealthParameters pretty(bool value)
        {
        ...
        ///<param name="value"><para>Default: True</para></param>
        public virtual CatHealthParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatHealthParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatHealthParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatHealthParameters filter_path(string value)
        {
