...
{
    ///<summary><see href="https://www.elastic.co/guide/en/elasticsearch/reference/5.x/indices-types-exists.html"/></summary>
    public class IndicesExistsTypeParameters : Parameters
    {
        ...
        public virtual IndicesExistsTypeParameters pretty(bool value)
        {
        ...
        public virtual IndicesExistsTypeParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual IndicesExistsTypeParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual IndicesExistsTypeParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual IndicesExistsTypeParameters filter_path(string value)
        {
