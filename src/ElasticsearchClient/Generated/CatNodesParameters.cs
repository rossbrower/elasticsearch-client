namespace Elasticsearch.Client
{
    ...
    public class CatNodesParameters : Parameters
    {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatNodesParameters pretty(bool value)
        {
        ...
        public virtual CatNodesParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatNodesParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatNodesParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatNodesParameters filter_path(string value)
        {
