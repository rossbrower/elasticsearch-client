...
namespace Elasticsearch.Client
{
    ...
    public partial class ElasticsearchClient
    {
        ...
        private HttpResponseMessage SnapshotRestore(string snapshot, string repository, Stream body)
        {
        ...
        /// <param name="repository">A repository name</param>
        /// <param name="body">Details of what to restore</param>
        private async Task<HttpResponseMessage> SnapshotRestoreAsync(string snapshot, string repository, Stream body)
        {
            string uri = string.Format("/_0/{1}/{0}/_restore", snapshot, repository);
        ...
        /// <param name="repository">A repository name</param>
        /// <param name="body">Details of what to restore</param>
        private async Task<HttpResponseMessage> SnapshotRestoreAsync(string snapshot, string repository, Byte[] body)
        {
            string uri = string.Format("/_0/{1}/{0}/_restore", snapshot, repository);
            return await this.ExecuteAsync("POST", uri, body);
        }
