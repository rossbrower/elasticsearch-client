namespace Elasticsearch.Client
{
    ...
    public class CatHelpParameters : Parameters
    {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatHelpParameters pretty(bool value)
        {
        ...
        public virtual CatHelpParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatHelpParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatHelpParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatHelpParameters filter_path(string value)
        {
