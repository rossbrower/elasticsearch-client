namespace Elasticsearch.Client
{
    ...
    public class CatPluginsParameters : Parameters
    {
        ...
        public virtual CatPluginsParameters format(string value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatPluginsParameters pretty(bool value)
        {
        ...
        public virtual CatPluginsParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatPluginsParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatPluginsParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatPluginsParameters filter_path(string value)
        {
