namespace Elasticsearch.Client
{
    ...
    public class CatNodeattrsParameters : Parameters
    {
        ...
        ///<param name="value"></param>
        public virtual CatNodeattrsParameters s(string value)
        {
            SetValue("s", value);
            return this;
        }
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatNodeattrsParameters pretty(bool value)
        {
        ...
        public virtual CatNodeattrsParameters human(bool value)
        {
        ...
        ///<param name="value"><para>Default: False</para></param>
        public virtual CatNodeattrsParameters error_trace(bool value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatNodeattrsParameters source(string value)
        {
        ...
        ///<param name="value"></param>
        public virtual CatNodeattrsParameters filter_path(string value)
        {
